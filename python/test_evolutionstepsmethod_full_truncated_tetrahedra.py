...
for face in W.domain.F:
    ...
    bottomplane = Plane(-normal, centroid - normal * (height / 2))
    points = {}
    h = face.halfedge
    while True:
    ...
    points = evolve(Seed2bottom, [-angle for _ in range(4)], height / 2, blockpoints[face]['points'], blockpoints[face]['edges'], blockpoints[face]['faces'])
