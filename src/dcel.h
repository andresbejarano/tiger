    ...
    */
    ...
    public:
        ...
        */
        ...
        /*
        Clips a geometry by a clipping plane.
        @param const toolkit::Plane & plane The reference to the clipping plane.
        @param VF & pvf The reference to the VF object to store the vertex coordinates and 
        vertex indices of the geometry as the positive half space of the clipping plane.
        @param VF & nvf The reference to the VF object to store the vertex coordinates and
        vertex indices of the geometry as the negative half space of the clipping plane.
        @param double threshold The threshold for values close to zero.
        */
        //void Clip(const toolkit::Plane & plane, VF & pvf, VF & nvf, const double threshold = 1e-8) const;
