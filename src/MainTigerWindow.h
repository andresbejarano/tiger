...
// 
class MainTigerWindow;

/*
The class to capture the mouse events in the VTK window while maintaining the trackball camera 
behavior. Code adapted from: https://lorensen.github.io/VTKExamples/site/Cxx/Picking/CellPicking/
*/
class TilePickerStyle : public vtkInteractorStyleTrackballCamera 
{

private:

    // 
    MainTigerWindow* m_tigerWindow;

public:

    static TilePickerStyle* New();
    ...
    */
    ...
    /*
    Function called when the user clicks the left mouse button in the VTK window.
    */
    virtual void OnLeftButtonDown();

    /*
    Function called when the user clicks the right mouse button in the VTK window.
    */
    virtual void OnRightButtonDown();

    /*
    Sets the pointer to the TIGER window.
    @param MainTigerWindow * tigerWindow
    */
    void SetTigerWindow(MainTigerWindow * tigerWindow);

};

/*
The class representing the main TIGER window. This class handles both UI and VTK elements.
*/
...
public:
    ...
    /*
    */
    //vtkIdType GetPickedTileCellId(int x, int y) const;
...
public slots:
    ...
    */
    ...
    /*
    Slot function executed when user clicks the edit Truncate blocks menu item.
    */
    //void on_actionEditTruncateBlocks_triggered();
    ...
    */
	...
	/*
	Slot function executed when user toggles the visualization of the interface polygons.
	*/
	//void on_actionViewInterfacePolygons_triggered();
