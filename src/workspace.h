...
public:
    ...
    */
    ...
    /*
    Generates the blocks by truncating the current ones and Set them to the assembly.
    @param double intrados The percentage of intrados to be preserved. It should be a value in 
    range [0, 1].
    @param double extrados The percentage of extrados to be preserved. It should be a value in 
    range [0, 1].
    */
    //void SetAssemblyUsingTruncatedblocks(double intrados, double extrados);
    ...
    */
    ...
    /*
    Truncates the blocks of the assembly.
    @param double intrados The percentage of intrados to be preserved. It should be a value in 
    range [0, 1].
    @param double extrados The percentage of extrados to be preserved. It should be a value in 
    range [0, 1].
    @param std::vector<std::shared_ptr<block>> & blocks The reference to the vector for storing the
    pointers to the truncated blocks.
    @return bool
    */
    //bool Truncateblocks(double intrados, double extrados, std::vector<std::shared_ptr<block>> & blocks) const;
